...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=1]{inflation_all_plot.pdf}
...
%\begin{figure}
%	\centering
%	\includegraphics[scale=.35]{looplot.pdf}
%	\caption{Approximate leave-one-out cross-validation (LOO) estimates and confidence intervals for the seven ZIB models fit to the SBIRT data. Lower LOO indicates a better fit. The models are displayed in ascending order by LOO estimates. All six LOZIB models (orange) fit the SBIRT data much better than the random intercept (RI) mode (blue). There is little difference in fit between the six different covariance models used with the LOZIB models. }
%	\label{fig:loo}
%\end{figure}
...
\begin{figure}[t]
	\centering
	\includegraphics[scale=.5]{DoDAllPlots.pdf}
...
\begin{table}[t]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{rrllll}
			...
			&& \multicolumn{1}{c}{Control} & \multicolumn{1}{c}{SBIRT} & \multicolumn{1}{c}{Control} & \multicolumn{1}{c}{SBIRT}  \\
			\hline
			\multirow[c]{4}{*}{Mean}&Baseline & \multicolumn{2}{c}{ 9.61(8.39, 10.9)}  & \multicolumn{2}{c}{6.85 (5.44, 8.45)}  \\ 
			&3 Month & 5.62 (4.57, 6.79) & 3.27 (2.58, 4.08) & 3.25 (2.36, 4.34)& 2.32 (1.62, 3.19) \\ 
			&6 Month & 4.77 (3.81, 5.85) & 3.68 (2.89, 4.57) & 2.45 (1.66, 3.44)& 2.24 (1.50, 3.15)\\ 
			&12 Month & 2.96 (2.25, 3.78) & 2.77 (2.08, 3.57) & 1.24 (.751, 1.9)& 1.57 (.958, 2.38) \\ 
			\hline
...
\begin{figure}[t]
	\centering
	\includegraphics[scale=.5]{MeanAllPlots.pdf}
